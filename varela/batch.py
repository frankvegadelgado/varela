...
def main():
    ...
    helper = argparse.ArgumentParser(prog="batch_approx", description="Estimating the Minimum Vertex Cover with an approximation factor of ≤ 3/2 for all undirected graphs encoded in DIMACS format and stored in a directory.")
