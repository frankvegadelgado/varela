...
def main():
    ...
    helper = argparse.ArgumentParser(prog="test_cover", description="The Varela Testing Application using randomly generated, large sparse matrices.")
    ...
    helper.add_argument('--version', action='version', version='%(prog)s 0.3.2')
