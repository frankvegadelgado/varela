...
def main():
    ...
    helper = argparse.ArgumentParser(prog="approx", description='Estimating the Minimum Vertex Cover with an approximation factor of at most 3/2 for undirected graph encoded in DIMACS format.')
